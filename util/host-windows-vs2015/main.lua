...
config.LIB_SOURCE                      = MOAI_SDK_HOME..'lib/windows/vs2015/Distribute/'
...
copyhostfiles = function()
    ...
    local files = MOAIFileSystem.listFiles( MOAI_SDK_HOME..'host-templates/windows/vs2015')
	for k, entry in pairs ( files ) do
			local fullpath = string.format ( '%s/%s',MOAI_SDK_HOME..'host-templates/windows/vs2015' , entry )
